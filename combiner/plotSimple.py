...
folder = "2016_06_29" #bis = 3cat, ter = 2cat
outString = "_29_jun"
...
for ic in range(len(channels)):
	...
	g95[ic].GetYaxis().SetRangeUser(0.001*scale,6*scale)
	...
	pt2.Draw()
	pt4.Draw()
	for ext in outFormats : cNice[ic].SaveAs("plots/preApp_29_jun/limitResonantFinal_"+channels[ic]+outString+ext)
