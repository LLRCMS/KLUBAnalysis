...
python cardMaker.py -i ${SOURCE}/analysis_TauTau/evalQCD_Plots_7Mar_pt40_allHHRew_fix/analysis_TauTau.cfg -f ${SOURCE}/analysis_TauTau/evalQCD_Plots_7Mar_pt40_allHHRew_fix/outPlotter.root -o $BASETAUTAU -v $VARTAUTAU -c TauTau --dir "_$OUTSTRING" -t 1 # -r 1
