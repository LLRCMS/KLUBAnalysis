...
def makeFinalPlots(tag, year, pdnn):
            ...
            if pdnn:
                ...
                for mass in masses:
                    for spin in spins:
                        ...
                        factory.produce(factory.data_mc_signal_with_ratio_worker, pars=pars, pdnn=pdnn_params)
...
if __name__ == '__main__':
    ...
    makeFinalPlots(args.tag, args.year, args.pdnn)
