...
DATA_MAP=(
	...
	# ["Tau__Run2018A"]="-n 400 -q short"
	# ["Tau__Run2018B"]="-n 400 -q short"
	# ["Tau__Run2018C"]="-n 400 -q short"
	# ["Tau__Run2018D"]="-n 600 -q short"
	...
	# ["MET__Run2018A"]="-n 400 -q short"
	# ["MET__Run2018B"]="-n 400 -q short"
	# ["MET__Run2018C"]="-n 400 -q short"
	# ["MET__Run2018D"]="-n 400 -q short"
)
...
MC_MAP=(
    # ["TTToHadronic"]="-n 20 -x ${FullyHadXSec} -q long"
    # ["TTTo2L2Nu"]="-n 300 -x ${FullyLepXSec} -q long"
    # ["TTToSemiLeptonic"]="-n 300 -x ${SemiLepXSec} -q long"
    ...
    # ["DYJetsToLL_LHEFilterPtZ-0To50"]="-n 120    -x 1409.22 -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_LHEFilterPtZ-50To100"]="-n 120  -x 377.12  -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_LHEFilterPtZ-100To250"]="-n 120 -x 92.24   -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_LHEFilterPtZ-250To400"]="-n 120 -x 3.512   -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_LHEFilterPtZ-400To650"]="-n 120 -x 0.4826  -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_LHEFilterPtZ-650ToInf"]="-n 120 -x 0.04487 -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_0J"]="-n 120 -x 4867.28  -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_1J"]="-n 120 -x 902.95   -g ${STITCHING_ON} --DY 0 -q long"
    # ["DYJetsToLL_2J"]="-n 120 -x 342.96   -g ${STITCHING_ON} --DY 0 -q long"

    # ["WJetsToLNu_T.+madgraph"]="-n 10 -x 48917.48 -y 1.213784 -z 70 -q short" # for 0 < HT < 70
    # ["WJetsToLNu_HT-70To100"]="-n 30 -x 1362 -y 1.213784 -q short"
    # ["WJetsToLNu_HT-100To200"]="-n 30 -x 1345 -y 1.213784 -q short"
    # ["WJetsToLNu_HT-200To400"]="-n 30 -x 359.7 -y 1.213784 -q short"
    # ["WJetsToLNu_HT-400To600"]="-n 30 -x 48.91 -y 1.213784 -q short"
    # ["WJetsToLNu_HT-600To800"]="-n 30 -x 12.05 -y 1.213784 -q short"
    # ["WJetsToLNu_HT-800To1200"]="-n 30 -x 5.501 -y 1.213784 -q short"
    # ["WJetsToLNu_HT-1200To2500"]="-n 30 -x 1.329 -y 1.213784 -q short"
    # ["WJetsToLNu_HT-2500ToInf"]="-n 30 -x 0.03216 -y 1.213784 -q short"

    # ["EWKWPlus2Jets_WToLNu"]="-n 20 -x 25.62 -q short"
    # ["EWKWMinus2Jets_WToLNu"]="-n 20 -x 20.25 -q short"
    # ["EWKZ2Jets_ZToLL"]="-n 20 -x 3.987 -q short"

    # ["ST_tW_antitop_5f_inclusive"]="-n 20 -x 35.85 -q short"
    # ["ST_tW_top_5f_inclusive"]="-n 20 -x 35.85 -q short"
    # ["ST_t-channel_antitop"]="-n 20 -x 80.95 -q short"
    # ["ST_t-channel_top"]="-n 20 -x 136.02 -q short"

    # ["GluGluHToTauTau"]="-n 10 -x 48.68 -y 0.06272 -q short"
    # ["VBFHToTauTau"]="-n 10 -x 3.766 -y 0.06272 -q short"
    # ["WplusHToTauTau"]="-n 10 -x 0.831 -y 0.06272 -q short"
    # ["WminusHToTauTau"]="-n 10 -x 0.527 -y 0.06272 -q short"
    # ["ZHToTauTau"]="-n 10 -x 0.880 -y 0.06272 -q short"

    # ["ZH_HToBB_ZToLL"]="-n 10 -x 0.880 -y ${ZH_HToBB_ZToLL_BR} -q short"
    # ["ZH_HToBB_ZToQQ"]="-n 10 -x 0.880 -y ${ZH_HToBB_ZToQQ_BR} -q short"

    # ["ttHToNonbb"]="-n 20 -x 0.5071 -y 0.3598 -q short"
    # ["ttHTobb"]="-n 20 -x 0.5071 -y 0.577 -q short"
    # ["ttHToTauTau"]="-n 20 -x 0.5071 -y 0.0632 -q short"
    
    # ["_WW_TuneCP5"]="-n 5 -x 118.7 -q short"
    # ["_WZ_TuneCP5"]="-n 5 -x 47.13 -q short"
    # ["_ZZ_TuneCP5"]="-n 5 -x 16.523 -q short"

    # ["49_WWW"]="-n 10 -x 0.209 -q short"
    # ["50_WWW"]="-n 10 -x 0.209 -q short"
    # ["51_WWZ"]="-n 10 -x 0.168 -q short"
    # ["52_WWZ"]="-n 10 -x 0.168 -q short"
    # ["53_WZZ"]="-n 10 -x 0.057 -q short"
    # ["54_WZZ"]="-n 10 -x 0.057 -q short"
    # ["55_ZZZ"]="-n 10 -x 0.0147 -q short"
    # ["56_ZZZ"]="-n 10 -x 0.0147 -q short"

    # ["TTWJetsToLNu"]="-n 20 -x 0.2043 -q short"
    # ["TTWJetsToQQ"]="-n 20 -x 0.4062 -q short"
    # ["TTZToLLNuNu"]="-n 20 -x 0.2529 -q short"
    # ["TTZToQQ"]="-n 200 -x 0.5104 -q short"
    # ["TTWW"]="-n 10 -x 0.006979 -q short"
    # ["TTZZ"]="-n 10 -x 0.001386 -q short"
    # ["TTWZ"]="-n 10 -x 0.00158 -q short"

    # ["TTWH"]="-n 10 -x 0.001143 -q short"
