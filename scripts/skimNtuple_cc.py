...
def parseInputFileList (fileName) :
    ...
    with open (fileName) as fIn:
        for line in fIn:
            ...
            if line:
                if 'dpm/in2p3.fr' in line:
                    filelist.append(line.replace("//dpm/in2p3.fr/home/cms/trivcat",":11001/"))
                else:
...
if __name__ == "__main__":
    ...
    currFolder = '/pbs/home/p/portales/hhbbtautau/CMSSW_11_1_0_pre6/src/KLUBAnalysis'
    ...
    if (opt.hadd != 'none') :
        ...
        scriptFile.write ('cd /pbs/home/p/portales/hhbbtautau/CMSSW_11_1_0_pre6/src\n')
