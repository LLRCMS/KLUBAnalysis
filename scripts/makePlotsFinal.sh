...
#lumi=13.4
lumi=41.6
reg=SR  # A:SR , B:SStight , C:OSinviso, D:SSinviso
...
do
  ...
  #
    ...
    python scripts/makeFinalPlots.py --dir analysis_$channel\_$tag --var bH_mass        --reg $reg --sel $baseline --channel $channel --lymin 0.7 --lumi $lumi  ${log[i]} --ratio  --tag $tag --label "H_{bb} mass [GeV]" --no-sig $others --quit
  ...
  ##taus
    ...
    python scripts/makeFinalPlots.py --dir analysis_$channel\_$tag --var tauH_SVFIT_mass --reg $reg --sel $baseline --channel $channel --lymin 0.7 --lumi $lumi ${log[i]} --ratio  --tag $tag --label "H_{#tau#tau}^{SVfit} [GeV]" --no-sig $others --quit
    python scripts/makeFinalPlots.py --dir analysis_$channel\_$tag --var tauH_mass       --reg $reg --sel $baseline --channel $channel --lymin 0.7 --lumi $lumi ${log[i]} --ratio  --tag $tag --label "H_{#tau#tau}^{vis} [GeV]" --no-sig $others --quit
  ...
  ##python scripts/makeFinalPlots.py --dir analysis_$channel\_$tag --var HHKin_mass_raw    --reg $reg --sel $baseline --channel $channel --lymin 0.7 --lumi $lumi ${log[i]} --ratio  --tag $tag --label "m_{HH}^{KinFit} [GeV]" --no-sig $others --quit
  ##python scripts/makeFinalPlots.py --dir analysis_$channel\_$tag --var MT2    --reg $reg --sel $baseline --channel $channel --lymin 0.7 --lumi $lumi ${log[i]} --ratio  --tag $tag --label "MT2 [GeV]" --no-sig $others --quit
