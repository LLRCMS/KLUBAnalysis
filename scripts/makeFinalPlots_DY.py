...
if __name__ == "__main__" :
    ...
    # RGB/HEX colors
    col = TColor()
    bkgColors["DY0b"]    = col.GetColor("#51ef86") #(TColor(68 ,186,104)).GetNumber() #gROOT.GetColor("#44BA68")
    bkgColors["DY1b"]    = col.GetColor("#44BA68") #(TColor(68 ,186,104)).GetNumber() #gROOT.GetColor("#44BA68")
    bkgColors["DY2b"]    = col.GetColor("#2b7c46") #(TColor(68 ,186,104)).GetNumber() #gROOT.GetColor("#44BA68")
    ...
    bkgLineColors = {}
    bkgLineColors["DY0b"]    = col.GetColor("#389956")
    bkgLineColors["DY1b"]    = col.GetColor("#389956")
    bkgLineColors["DY2b"]    = col.GetColor("#389956")
    ...
    hDY0b = getHisto("DY0b", hBkgs,doOverflow)
    hDY1b = getHisto("DY1b", hBkgs,doOverflow)
    hDY2b = getHisto("DY2b", hBkgs,doOverflow)
    ...
    hBkgList = [hDY2b,hothers, hWJets, hTT, hDY0b, hDY1b] ## full list for stack
    ...
    hBkgNameList = ["DY 2b","Others", "W + jets", "t#bar{t}" , "DY 0b" , "DY 1b" ] # list for legend
