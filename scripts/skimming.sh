...
python scripts/skimNtuple.py -o /data_CMS/cms/govoni/test_submit_to_tier3/SKIM_WJets            -i /data_CMS/cms/govoni/test_submit_to_tier3/HiggsTauTauOutput_WJets_-1Events_0Skipped_1437551416.48          -x 61526.7
