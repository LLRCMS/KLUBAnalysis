...
59095
  ...
  for (Long64_t iEvent = 0 ; true ; ++iEvent) 
      ...
      if(pType == 2)                //1st tau
	{
      ...
      theSmallTree.m_totalWeight = (isMC ? (41557./4.7254582e+08) * theSmallTree.m_MC_weight * theSmallTree.m_PUReweight * theSmallTree.m_DYscale_MTT * trigSF * theSmallTree.m_IdAndIsoAndFakeSF_deep_pt * theSmallTree.m_L1pref_weight: 1.0);
      //total weight used for sync: the denominator is h_eff->GetBinContent(1)
