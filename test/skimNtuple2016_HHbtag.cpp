  ...
  for (Long64_t iEvent = 0 ; true ; ++iEvent) 
    {
      ...
      if (isHHsignal && isHHNLO && HHrewType != kNone)
      {
        ...
        if (fileName.find("node_cHHH0")    != std::string::npos) addWeight = 1. / 56931.4 / 4.; // computed with hhReweight/MakeMap_getNLOweights.cpp
        if (fileName.find("node_cHHH1")    != std::string::npos) addWeight = 1. / 26732.6 / 4.; // computed with hhReweight/MakeMap_getNLOweights.cpp
        if (fileName.find("node_cHHH2p45") != std::string::npos) addWeight = 1. / 10752.6 / 4.; // computed with hhReweight/MakeMap_getNLOweights.cpp
        if (fileName.find("node_cHHH5")    != std::string::npos) addWeight = 1. / 77709.6 / 4.; // computed with hhReweight/MakeMap_getNLOweights.cpp
        if (DEBUG)
        {
