...
int main (int argc, char** argv)
{
  ...
  JECKLUBinterface JECprovider("2017");
  ...
  SmearedJetProducer Smearer("2017", doSmearing, smearVariation);
  ...
  tau_trigger::SFProvider * tauTrgSF_ditau = new tau_trigger::SFProvider("weights/trigger_SF_UL/2017/2017UL_tauTriggerEff_DeepTau2017v2p1.root", "ditau", "Medium");
  tau_trigger::SFProvider * tauTrgSF_mutau = new tau_trigger::SFProvider("weights/trigger_SF_UL/2017/2017UL_tauTriggerEff_DeepTau2017v2p1.root", "mutau", "Medium");
  tau_trigger::SFProvider * tauTrgSF_etau  = new tau_trigger::SFProvider("weights/trigger_SF_UL/2017/2017UL_tauTriggerEff_DeepTau2017v2p1.root", "etau" , "Medium");
//  tau_trigger::SFProvider * tauTrgSF_vbf   = new tau_trigger::SFProvider("weights/trigger_SF_UL/2017/2017UL_tauTriggerEff_DeepTau2017v2p1.root", "ditauvbf", "Medium"); // NOT IN FILE !
  tau_trigger::SFProvider * tauTrgSF_vbf   = new tau_trigger::SFProvider("weights/trigger_SF_UL/2017/2017UL_tauTriggerEff_DeepTau2017v2p1.root", "ditau", "Medium"); // using ditau as placeholder, while waiting for SF computation
  ...
  TFile* VBFjets_file = new TFile ("weights/trigger_SF_Legacy/2017/2017_VBFHTauTauTrigger_JetLegs.root");
  ...
  TauIDSFTool *Deep_antiJet_medium_dm = new TauIDSFTool("UL2017","DeepTau2017v2p1VSjet","Medium",1); // for DeepTauv2p1 vs jets Medium
  TauIDSFTool *Deep_antiJet_medium_pt = new TauIDSFTool("UL2017","DeepTau2017v2p1VSjet","Medium");   // for DeepTauv2p1 vs jets Medium
  TauIDSFTool *Deep_antiJet_2d        = new TauIDSFTool("UL2017", "Medium", "VVLoose"); // for DeepTauv2p1 vs jets Medium in DM/pT bins
  ...
  if (HHrewType != kNone)
  {
    ...
    hhreweighter = new HHReweight5D(coeffFile, hhreweighterInputMap, EFTbm, string("2017"), order_rew, uncertainty_rew, cms_fake_rew);
  }
  ...
  for (Long64_t iEvent = 0 ; true ; ++iEvent)
  {
    ...
    float idSF_MVA		   = 1.0;        // use this for MVA2017v2
    ...
    float idFakeSF_MVA	   = 1.0;    // use this for MVA2017v2 + e/mu->tauh fake SF
	...
	float idFakeSF_tauid_2d_systgt40_up				  = 1.f;				 
	float idFakeSF_tauid_2d_systgt40_down			  = 1.f;			   
	...
	float idSF_leg1				  = 1.f;
	float idSF_leg1_MVA_vsJet     = 1.f;
	float idSF_leg1_MVA_vsEle     = 1.f;
	float idSF_leg1_MVA_vsMu      = 1.f;
	...
	float idSF_leg2				  = 1.f;
	float idSF_leg2_MVA_vsJet	  = 1.f;
	float idSF_leg2_MVA_vsEle	  = 1.f;
	float idSF_leg2_MVA_vsMu	  = 1.f;
	...
	if (isMC and pType==2)
	  {
		idSF_leg1_MVA_vsJet = MVA_antiJet_medium->getSFvsDM (leg1pt , tau1DM, tau1Genmatch);
		idSF_leg1_MVA_vsEle = MVA_antiEle_vloose->getSFvsEta(leg1eta, tau1Genmatch);
		idSF_leg1_MVA_vsMu  = MVA_antiMu_loose  ->getSFvsEta(leg1eta, tau1Genmatch);
	...
	Float_t idSF_leg1_deep_vsJet_2d_systgt40_up				  = 1.f;
	Float_t idSF_leg1_deep_vsJet_2d_systgt40_down			  = 1.f;
	...
	Float_t idSF_leg2_deep_vsJet_2d_systgt40_up				  = 1.f;
	Float_t idSF_leg2_deep_vsJet_2d_systgt40_down			  = 1.f;
	...
	if (isMC and (pType == 0 or pType == 1))
	  {
		idSF_MVA		 = idSF_leg1 * idSF_leg2_MVA_vsJet;
		...
		idFakeSF_MVA	 = idSF_leg1 * idSF_leg2_MVA_vsJet  * idSF_leg2_MVA_vsEle  * idSF_leg2_MVA_vsMu;
		fakeRateSF_MVA	 = idSF_leg2_MVA_vsEle  * idSF_leg2_MVA_vsMu;
		...
		idFakeSF_tauid_2d_systgt40_up				= except_VsJet * idSF_leg2_deep_vsJet_2d_systgt40_up;
		idFakeSF_tauid_2d_systgt40_down				= except_VsJet * idSF_leg2_deep_vsJet_2d_systgt40_down;
		...
		idFakeSF_mutauFR_etaLt0p4_up      = except_vsMu * idSF_leg2_deep_vsMu_up[1];
	  ...
	  {
		idSF_MVA	 = idSF_leg1_MVA_vsJet     * idSF_leg2_MVA_vsJet;
		...
		idFakeSF_MVA	 = idSF_leg1_MVA_vsJet * idSF_leg1_MVA_vsEle * idSF_leg1_MVA_vsMu * idSF_leg2_MVA_vsJet	* idSF_leg2_MVA_vsEle  * idSF_leg2_MVA_vsMu;
		fakeRateSF_MVA	 = idSF_leg1_MVA_vsEle * idSF_leg1_MVA_vsMu * idSF_leg2_MVA_vsEle  * idSF_leg2_MVA_vsMu;
		...
		idFakeSF_tauid_2d_systgt40_up				= except_VsJet * idSF_leg1_deep_vsJet_2d_systgt40_up			   * idSF_leg2_deep_vsJet_2d_systgt40_up;
		idFakeSF_tauid_2d_systgt40_down				= except_VsJet * idSF_leg1_deep_vsJet_2d_systgt40_down			   * idSF_leg2_deep_vsJet_2d_systgt40_down;
	  ...
	  {
		idSF_MVA = idSF_deep_dm = idFakeSF_MVA = idFakeSF_deep_dm = idSF_leg1 * idSF_leg2;
	  }
	
	if (DEBUG) {
	  cout << "--- DEBUG idSF ---" << endl;
	  cout << "pairType  : "              << pType                   << endl;
	  cout << "totSF MVA : "              << idSF_MVA << endl;
	...
	theSmallTree.m_FakeRateSF_MVA	= fakeRateSF_MVA;
	...
	theSmallTree.m_idFakeSF_tauid_2d_systgt40_up				= idFakeSF_tauid_2d_systgt40_up;
	theSmallTree.m_idFakeSF_tauid_2d_systgt40_down				= idFakeSF_tauid_2d_systgt40_down;
...
//        }
  ...
  theSmallTree.m_jets_pnet_undef.push_back(theBigTree.bParticleNetAK4JetTags_probundef->at(iJet));
	...
	cout << "------------------------" << endl;
      ...
      theSmallTree.m_totalWeight = (isMC ? (41529./472545790.) * theSmallTree.m_MC_weight * theSmallTree.m_PUReweight * theSmallTree.m_DYscale_MTT * trigSF * theSmallTree.m_IdFakeSF_deep_pt * theSmallTree.m_L1pref_weight * theSmallTree.m_prescaleWeight * theSmallTree.m_PUjetID_SF: 1.0);
    ...
    theSmallTree.m_fatjet_massIndependentDeepDoubleBvLJetTags_probHbb = theBigTree.ak8jets_massIndependentDeepDoubleBvLJetTags_probHbb->at(fjIdx);
    theSmallTree.m_fatjet_deepDoubleBvLJetTags_probHbb = theBigTree.ak8jets_deepDoubleBvLJetTags_probHbb->at(fjIdx);
    theSmallTree.m_fatjet_deepBoostedJetTags_probHbb = theBigTree.ak8jets_deepBoostedJetTags_probHbb->at(fjIdx);
    theSmallTree.m_fatjet_particleNetJetTags_probHbb = theBigTree.ak8jets_particleNetJetTags_probHbb->at(fjIdx);
    theSmallTree.m_fatjet_particleNetDiscriminatorsJetTags_HbbvsQCD = theBigTree.ak8jets_particleNetDiscriminatorsJetTags_HbbvsQCD->at(fjIdx);
    ...
    if (DEBUG) //FRA DEBUG
    {
      ...
      cout << "  IDandISO MVA : " << theSmallTree.m_IdSF_MVA << endl;
      cout << "    w/ FakeRate: " << theSmallTree.m_IdFakeSF_MVA << endl;
    ...
    if (DEBUG) //FRA DEBUG
    {
      ...
      //cout << "Yield weight MVA : " << theSmallTree.m_MC_weight * theSmallTree.m_PUReweight * theSmallTree.m_IdFakeSF_MVA * theSmallTree.m_trigSF << endl;
