...
void ProduceSyncNtuple(Bool_t DataTrue_MCFalse, TString InputFileName, TString OutputFileName, TString Channel, ConfigParser* gConfigParser)
{
  ...
  m_SampleChain->SetBranchAddress("lheHt", &lheHt);
  m_SampleChain->SetBranchAddress("aMCatNLOweight", &aMCatNLOweight);
  ...
  m_SampleChain->SetBranchAddress("genpart_MSSMHMothInd", &genpart_MSSMHMothInd);
  ...
  m_SampleChain->SetBranchAddress("genpart_WMothInd", &genpart_WMothInd);
  m_SampleChain->SetBranchAddress("genpart_bMothInd", &genpart_bMothInd);
  m_SampleChain->SetBranchAddress("genpart_HZDecayMode", &genpart_HZDecayMode);
  m_SampleChain->SetBranchAddress("genpart_TopDecayMode", &genpart_TopDecayMode);
  m_SampleChain->SetBranchAddress("genpart_WDecayMode", &genpart_WDecayMode);
  ...
  m_SampleChain->SetBranchAddress("genjet_px", &genjet_px);
  m_SampleChain->SetBranchAddress("genjet_py", &genjet_py);
  m_SampleChain->SetBranchAddress("genjet_pz", &genjet_pz);
  m_SampleChain->SetBranchAddress("genjet_e", &genjet_e);
  m_SampleChain->SetBranchAddress("genjet_partonFlavour", &genjet_partonFlavour);
  m_SampleChain->SetBranchAddress("genjet_hadronFlavour", &genjet_hadronFlavour);
  ...
  m_SampleChain->SetBranchAddress("jets_genjetIndex", &jets_genjetIndex);
