  ...
  for (Long64_t iEvent = 0 ; true ; ++iEvent) 
      ...
      if (isHHsignal)
	{
      ...
      if (pType == 0 && isMC)
      {
        ...
        {
          if (tau2eta < 1.448 ) idAndIsoSF_leg2_deep_vsEle = 1.38; // anti-ele VVloose
          if (tau2eta > 1.558 ) idAndIsoSF_leg2_deep_vsEle = 1.29; // anti-ele VVloose
        }
      ...
      else if (pType == 2 && isMC)
      {
        ...
        {
          if (tau1eta < 1.448 ) idAndIsoSF_leg1_deep_vsEle = 1.38; // anti-ele VVLoose
          if (tau1eta > 1.558 ) idAndIsoSF_leg1_deep_vsEle = 1.29; // anti-ele VVLoose
        }
