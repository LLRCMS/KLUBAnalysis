...
for m in masses:
    ...
    n_1b1j = h_1b1j.Integral()
    n_2b0j = h_2b0j.Integral()
    n_boos = h_boos.Integral()
    ...
    n_1b1jMcut = h_1b1jMcut.Integral()
    n_2b0jMcut = h_2b0jMcut.Integral()
    n_boosMcut = h_boosMcut.Integral()
    ...
    if channel != 'TauTau': ## also BDT
        ...
        n_1b1jMcutBDT = h_1b1jMcutBDT.Integral()
        n_2b0jMcutBDT = h_2b0jMcutBDT.Integral()
        n_boosMcutBDT = h_boosMcutBDT.Integral()
        n_totMcutBDT = n_1b1jMcutBDT + n_2b0jMcutBDT + n_boosMcutBDT
    ...
    gr_1b1j.SetPoint(gr_1b1j.GetN(), m, n_1b1j) 
    gr_2b0j.SetPoint(gr_2b0j.GetN(), m, n_2b0j) 
    gr_boos.SetPoint(gr_boos.GetN(), m, n_boos) 
    gr_tot.SetPoint(gr_tot.GetN(), m, n_tot) 
    gr_1b1jMcut.SetPoint(gr_1b1jMcut.GetN(), m, n_1b1jMcut) 
    gr_2b0jMcut.SetPoint(gr_2b0jMcut.GetN(), m, n_2b0jMcut) 
    gr_boosMcut.SetPoint(gr_boosMcut.GetN(), m, n_boosMcut) 
    gr_totMcut.SetPoint(gr_totMcut.GetN(), m, n_totMcut) 
    if gr_1b1jMcutBDT: gr_1b1jMcutBDT.SetPoint(gr_1b1jMcutBDT.GetN(), m, n_1b1jMcutBDT) 
    if gr_2b0jMcutBDT: gr_2b0jMcutBDT.SetPoint(gr_2b0jMcutBDT.GetN(), m, n_2b0jMcutBDT) 
    if gr_boosMcutBDT: gr_boosMcutBDT.SetPoint(gr_boosMcutBDT.GetN(), m, n_boosMcutBDT) 
    if gr_totMcutBDT: gr_totMcutBDT.SetPoint(gr_totMcutBDT.GetN(), m, n_totMcutBDT) 


    # gr_trg.SetPoint(gr_trg.GetN(), m, n_trg/n_all)
    # gr_tautau.SetPoint(gr_tautau.GetN(), m, n_tautau/n_all)
    # gr_3lep.SetPoint(gr_3lep.GetN(), m, n_3lep/n_all)
    # gr_2jets.SetPoint(gr_2jets.GetN(), m, n_2jets/n_all)
    # gr_btag.SetPoint(gr_btag.GetN(), m, n_btag)
    # gr_mcut.SetPoint(gr_mcut.GetN(), m, n_mcut)
    # if gr_BDT : gr_BDT.SetPoint(gr_BDT.GetN(), m, n_BDT)
...
if gr_1b1jMcutBDT: gr_1b1jMcutBDT.SetName('gr_1b1jMcutBDT')
if gr_2b0jMcutBDT: gr_2b0jMcutBDT.SetName('gr_2b0jMcutBDT')
if gr_boosMcutBDT: gr_boosMcutBDT.SetName('gr_boosMcutBDT')
if gr_totMcutBDT: gr_totMcutBDT.SetName('gr_totMcutBDT')
...
fOut = ROOT.TFile('yieldsPlots_%s_resonant_%s.root' % (channel, stype), 'recreate')
# gr_trg.Write()
# gr_tautau.Write()
# gr_3lep.Write()
# gr_2jets.Write()
...
gr_boosMcut.Write()
gr_totMcut.Write()
if gr_1b1jMcutBDT: gr_1b1jMcutBDT.Write()
if gr_2b0jMcutBDT: gr_2b0jMcutBDT.Write()
if gr_boosMcutBDT: gr_boosMcutBDT.Write()
if gr_totMcutBDT: gr_totMcutBDT.Write()
