...
for m in masses:
    ...
    gr_1b1j.SetPoint(gr_1b1j.GetN(), m-20., n_1b1j) 
    gr_2b0j.SetPoint(gr_2b0j.GetN(), m-20., n_2b0j) 
    gr_boos.SetPoint(gr_boos.GetN(), m-20., n_boos) 
    gr_tot.SetPoint(gr_tot.GetN(), m-20., n_tot) 
    gr_1b1jMcut.SetPoint(gr_1b1jMcut.GetN(), m-20., n_1b1jMcut) 
    gr_2b0jMcut.SetPoint(gr_2b0jMcut.GetN(), m-20., n_2b0jMcut) 
    gr_boosMcut.SetPoint(gr_boosMcut.GetN(), m-20., n_boosMcut) 
    gr_totMcut.SetPoint(gr_totMcut.GetN(), m-20., n_totMcut) 
...
fOut = ROOT.TFile('yieldsPlots_%s_nonresonantKlambda_%s.root' % (channel, stype), 'recreate')
