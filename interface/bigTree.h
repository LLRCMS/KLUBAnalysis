...
class bigTree {
 public :
  ...
  Float_t         MC_weight;
  Float_t         MC_QCDscale_perevent;
  Float_t         MC_pdf_perevent;
  Float_t         MC_astrong_perevent;
  Float_t         lheVPt;
  Float_t         lheHt;
  ...
  TBranch        *b_MC_weight;   //!
  TBranch        *b_MC_pdf_perevent;   //!
  TBranch        *b_MC_QCDscale_perevent;   //!
  TBranch        *b_MC_astrong_perevent;   //!
  TBranch        *b_lheVPt;   //!
  TBranch        *b_lheHt;   //!
  ...
  void Init(TChain *tree)
  {
    ...
    if(fChain->GetListOfBranches()->FindObject("MC_weight"))
    {
	  ...
	  fChain->SetBranchAddress("MC_QCDscale_perevent", &MC_QCDscale_perevent, &b_MC_QCDscale_perevent);
	  fChain->SetBranchAddress("MC_pdf_perevent", &MC_pdf_perevent, &b_MC_pdf_perevent);
	  fChain->SetBranchAddress("MC_astrong_perevent", &MC_astrong_perevent, &b_MC_astrong_perevent);
