 ...
 public :
  ...
  void Init(TChain *tree)
  {
    ...
    if(fChain->GetListOfBranches()->FindObject("MC_weight"))
    {
      ...
      fChain->SetBranchAddress("MC_QCDscale_0", &MC_QCDscale[0], &b_MC_QCDscale0);
      fChain->SetBranchAddress("MC_QCDscale_1", &MC_QCDscale[1], &b_MC_QCDscale1);
      fChain->SetBranchAddress("MC_QCDscale_2", &MC_QCDscale[2], &b_MC_QCDscale2);
      fChain->SetBranchAddress("MC_QCDscale_3", &MC_QCDscale[3], &b_MC_QCDscale3);
      fChain->SetBranchAddress("MC_QCDscale_4", &MC_QCDscale[4], &b_MC_QCDscale4);
      fChain->SetBranchAddress("MC_QCDscale_5", &MC_QCDscale[5], &b_MC_QCDscale5);
      fChain->SetBranchAddress("MC_QCDscale_6", &MC_QCDscale[6], &b_MC_QCDscale6);
      fChain->SetBranchAddress("MC_pdf_0", &MC_pdf[0], &b_MC_pdf0);
      fChain->SetBranchAddress("MC_pdf_1", &MC_pdf[1], &b_MC_pdf1);
      fChain->SetBranchAddress("MC_pdf_2", &MC_pdf[2], &b_MC_pdf2);
      fChain->SetBranchAddress("MC_pdf_3", &MC_pdf[3], &b_MC_pdf3);
      fChain->SetBranchAddress("MC_pdf_4", &MC_pdf[4], &b_MC_pdf4);
      fChain->SetBranchAddress("MC_pdf_5", &MC_pdf[5], &b_MC_pdf5);
      fChain->SetBranchAddress("MC_pdf_6", &MC_pdf[6], &b_MC_pdf6);
      fChain->SetBranchAddress("MC_pdf_7", &MC_pdf[7], &b_MC_pdf7);
      fChain->SetBranchAddress("MC_pdf_8", &MC_pdf[8], &b_MC_pdf8);
      fChain->SetBranchAddress("MC_pdf_9", &MC_pdf[9], &b_MC_pdf9);
      fChain->SetBranchAddress("MC_pdf_10", &MC_pdf[10], &b_MC_pdf10);
      fChain->SetBranchAddress("MC_pdf_11", &MC_pdf[11], &b_MC_pdf11);
      fChain->SetBranchAddress("MC_pdf_12", &MC_pdf[12], &b_MC_pdf12);
      fChain->SetBranchAddress("MC_pdf_13", &MC_pdf[13], &b_MC_pdf13);
      fChain->SetBranchAddress("MC_pdf_14", &MC_pdf[14], &b_MC_pdf14);
      fChain->SetBranchAddress("MC_pdf_15", &MC_pdf[15], &b_MC_pdf15);
      fChain->SetBranchAddress("MC_pdf_16", &MC_pdf[16], &b_MC_pdf16);
      fChain->SetBranchAddress("MC_pdf_17", &MC_pdf[17], &b_MC_pdf17);
      fChain->SetBranchAddress("MC_pdf_18", &MC_pdf[18], &b_MC_pdf18);
      fChain->SetBranchAddress("MC_pdf_19", &MC_pdf[19], &b_MC_pdf19);
      fChain->SetBranchAddress("MC_pdf_20", &MC_pdf[20], &b_MC_pdf20);
      fChain->SetBranchAddress("MC_pdf_21", &MC_pdf[21], &b_MC_pdf21);
      fChain->SetBranchAddress("MC_pdf_22", &MC_pdf[22], &b_MC_pdf22);
      fChain->SetBranchAddress("MC_pdf_23", &MC_pdf[23], &b_MC_pdf23);
      fChain->SetBranchAddress("MC_pdf_24", &MC_pdf[24], &b_MC_pdf24);
      fChain->SetBranchAddress("MC_pdf_25", &MC_pdf[25], &b_MC_pdf25);
      fChain->SetBranchAddress("MC_pdf_26", &MC_pdf[26], &b_MC_pdf26);
      fChain->SetBranchAddress("MC_pdf_27", &MC_pdf[27], &b_MC_pdf27);
      fChain->SetBranchAddress("MC_pdf_28", &MC_pdf[28], &b_MC_pdf28);
      fChain->SetBranchAddress("MC_pdf_29", &MC_pdf[29], &b_MC_pdf29);
      fChain->SetBranchAddress("MC_pdf_30", &MC_pdf[30], &b_MC_pdf30);
      fChain->SetBranchAddress("MC_pdf_31", &MC_pdf[31], &b_MC_pdf31);
      fChain->SetBranchAddress("MC_pdf_32", &MC_pdf[32], &b_MC_pdf32);
      fChain->SetBranchAddress("MC_pdf_33", &MC_pdf[33], &b_MC_pdf33);
      fChain->SetBranchAddress("MC_pdf_34", &MC_pdf[34], &b_MC_pdf34);
      fChain->SetBranchAddress("MC_pdf_35", &MC_pdf[35], &b_MC_pdf35);
      fChain->SetBranchAddress("MC_pdf_36", &MC_pdf[36], &b_MC_pdf36);
      fChain->SetBranchAddress("MC_pdf_37", &MC_pdf[37], &b_MC_pdf37);
      fChain->SetBranchAddress("MC_pdf_38", &MC_pdf[38], &b_MC_pdf38);
      fChain->SetBranchAddress("MC_pdf_39", &MC_pdf[39], &b_MC_pdf39);
      fChain->SetBranchAddress("MC_pdf_40", &MC_pdf[40], &b_MC_pdf40);
      fChain->SetBranchAddress("MC_pdf_41", &MC_pdf[41], &b_MC_pdf41);
      fChain->SetBranchAddress("MC_pdf_42", &MC_pdf[42], &b_MC_pdf42);
      fChain->SetBranchAddress("MC_pdf_43", &MC_pdf[43], &b_MC_pdf43);
      fChain->SetBranchAddress("MC_pdf_44", &MC_pdf[44], &b_MC_pdf44);
      fChain->SetBranchAddress("MC_pdf_45", &MC_pdf[45], &b_MC_pdf45);
      fChain->SetBranchAddress("MC_pdf_46", &MC_pdf[46], &b_MC_pdf46);
      fChain->SetBranchAddress("MC_pdf_47", &MC_pdf[47], &b_MC_pdf47);
      fChain->SetBranchAddress("MC_pdf_48", &MC_pdf[48], &b_MC_pdf48);
      fChain->SetBranchAddress("MC_pdf_49", &MC_pdf[49], &b_MC_pdf49);
      fChain->SetBranchAddress("MC_pdf_50", &MC_pdf[50], &b_MC_pdf50);
      fChain->SetBranchAddress("MC_pdf_51", &MC_pdf[51], &b_MC_pdf51);
      fChain->SetBranchAddress("MC_pdf_52", &MC_pdf[52], &b_MC_pdf52);
      fChain->SetBranchAddress("MC_pdf_53", &MC_pdf[53], &b_MC_pdf53);
      fChain->SetBranchAddress("MC_pdf_54", &MC_pdf[54], &b_MC_pdf54);
      fChain->SetBranchAddress("MC_pdf_55", &MC_pdf[55], &b_MC_pdf55);
      fChain->SetBranchAddress("MC_pdf_56", &MC_pdf[56], &b_MC_pdf56);
      fChain->SetBranchAddress("MC_pdf_57", &MC_pdf[57], &b_MC_pdf57);
      fChain->SetBranchAddress("MC_pdf_58", &MC_pdf[58], &b_MC_pdf58);
      fChain->SetBranchAddress("MC_pdf_59", &MC_pdf[59], &b_MC_pdf59);
      fChain->SetBranchAddress("MC_pdf_60", &MC_pdf[60], &b_MC_pdf60);
      fChain->SetBranchAddress("MC_pdf_61", &MC_pdf[61], &b_MC_pdf61);
      fChain->SetBranchAddress("MC_pdf_62", &MC_pdf[62], &b_MC_pdf62);
      fChain->SetBranchAddress("MC_pdf_63", &MC_pdf[63], &b_MC_pdf63);
      fChain->SetBranchAddress("MC_pdf_64", &MC_pdf[64], &b_MC_pdf64);
      fChain->SetBranchAddress("MC_pdf_65", &MC_pdf[65], &b_MC_pdf65);
      fChain->SetBranchAddress("MC_pdf_66", &MC_pdf[66], &b_MC_pdf66);
      fChain->SetBranchAddress("MC_pdf_67", &MC_pdf[67], &b_MC_pdf67);
      fChain->SetBranchAddress("MC_pdf_68", &MC_pdf[68], &b_MC_pdf68);
      fChain->SetBranchAddress("MC_pdf_69", &MC_pdf[69], &b_MC_pdf69);
      fChain->SetBranchAddress("MC_pdf_70", &MC_pdf[70], &b_MC_pdf70);
      fChain->SetBranchAddress("MC_pdf_71", &MC_pdf[71], &b_MC_pdf71);
      fChain->SetBranchAddress("MC_pdf_72", &MC_pdf[72], &b_MC_pdf72);
      fChain->SetBranchAddress("MC_pdf_73", &MC_pdf[73], &b_MC_pdf73);
      fChain->SetBranchAddress("MC_pdf_74", &MC_pdf[74], &b_MC_pdf74);
      fChain->SetBranchAddress("MC_pdf_75", &MC_pdf[75], &b_MC_pdf75);
      fChain->SetBranchAddress("MC_pdf_76", &MC_pdf[76], &b_MC_pdf76);
      fChain->SetBranchAddress("MC_pdf_77", &MC_pdf[77], &b_MC_pdf77);
      fChain->SetBranchAddress("MC_pdf_78", &MC_pdf[78], &b_MC_pdf78);
      fChain->SetBranchAddress("MC_pdf_79", &MC_pdf[79], &b_MC_pdf79);
      fChain->SetBranchAddress("MC_pdf_80", &MC_pdf[80], &b_MC_pdf80);
      fChain->SetBranchAddress("MC_pdf_81", &MC_pdf[81], &b_MC_pdf81);
      fChain->SetBranchAddress("MC_pdf_82", &MC_pdf[82], &b_MC_pdf82);
      fChain->SetBranchAddress("MC_pdf_83", &MC_pdf[83], &b_MC_pdf83);
      fChain->SetBranchAddress("MC_pdf_84", &MC_pdf[84], &b_MC_pdf84);
      fChain->SetBranchAddress("MC_pdf_85", &MC_pdf[85], &b_MC_pdf85);
      fChain->SetBranchAddress("MC_pdf_86", &MC_pdf[86], &b_MC_pdf86);
      fChain->SetBranchAddress("MC_pdf_87", &MC_pdf[87], &b_MC_pdf87);
      fChain->SetBranchAddress("MC_pdf_88", &MC_pdf[88], &b_MC_pdf88);
      fChain->SetBranchAddress("MC_pdf_89", &MC_pdf[89], &b_MC_pdf89);
      fChain->SetBranchAddress("MC_pdf_90", &MC_pdf[90], &b_MC_pdf90);
      fChain->SetBranchAddress("MC_pdf_91", &MC_pdf[91], &b_MC_pdf91);
      fChain->SetBranchAddress("MC_pdf_92", &MC_pdf[92], &b_MC_pdf92);
      fChain->SetBranchAddress("MC_pdf_93", &MC_pdf[93], &b_MC_pdf93);
      fChain->SetBranchAddress("MC_pdf_94", &MC_pdf[94], &b_MC_pdf94);
      fChain->SetBranchAddress("MC_pdf_95", &MC_pdf[95], &b_MC_pdf95);
      fChain->SetBranchAddress("MC_pdf_96", &MC_pdf[96], &b_MC_pdf96);
      fChain->SetBranchAddress("MC_pdf_97", &MC_pdf[97], &b_MC_pdf97);
      fChain->SetBranchAddress("MC_pdf_98", &MC_pdf[98], &b_MC_pdf98);
      fChain->SetBranchAddress("MC_pdf_99", &MC_pdf[99], &b_MC_pdf99);
      fChain->SetBranchAddress("MC_pdf_100", &MC_pdf[100], &b_MC_pdf100);
      fChain->SetBranchAddress("MC_astrong_0", &MC_astrong[0], &b_MC_astrong0);
      fChain->SetBranchAddress("MC_astrong_1", &MC_astrong[1], &b_MC_astrong1);
