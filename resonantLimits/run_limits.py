...
def run_limits(in_tags, channels, selections, selection_prefixes, masses,
               period, tag, var, signal, work_dir, config_files,
               user, dryrun):
    """
    - selection_prefixes:
...
if __name__ == "__main__":
    ...
    for var in varsfit:
        run_limits(in_tags, channels, selections, selection_prefixes, masses, period, out_tag, var, signal, work_dir, cfg_files, FLAGS.user, FLAGS.dryrun)
